...
#Gets data from all of the databases using DatabaseManager
df_incidents = db.get_dataframe("SELECT * FROM cyber_incidents")
df_datasets = db.get_dataframe("SELECT * FROM datasets_metadata")
df_tickets = db.get_dataframe("SELECT * FROM it_tickets")
