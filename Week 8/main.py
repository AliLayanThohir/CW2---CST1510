#Imports needed to run this file 
import pandas as pd
import os
...
from Menu import setup_database
from app.data.pipeline import create_and_load_all_csv_data

#Function to run comprehensive test and make sure everything works
def run_comprehensive_tests():
    ...
    strength = check_password_strength("MdiumP@ss3")
    ...
    #Loading and printing CSV 
    print("Creating and loading dummy data into tables")
    create_and_load_all_csv_data(conn)
    ...
    print("\nPlease delete the database and dummy csv's manually to make sure no redundant data is there in the main file.")
    conn.close()   
